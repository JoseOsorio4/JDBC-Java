...
public class ReporteService {
    ...
    public Set<Libro> librosNuncaPrestados() throws SQLException {
        ...
        // Guardar los titulos que si tienen prestamo activo
        ...
        // Agregar los libros que NO estan prestados actualmente
     ...
     */
    public Map<String, Integer> contarPrestamosActivosPorTitulo()
            throws SQLException {
        ...
        for (PrestamoDetalle prestamo : activos) {
            ...
            if (conteo.containsKey(titulo)) {
                int cantidadActual = conteo.get(titulo);
                conteo.put(titulo, cantidadActual + 1);
            } else {
                conteo.put(titulo, 1);
            }
        }
